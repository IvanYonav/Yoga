...
/*!******************************!*\
  ...
  \******************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js");o.default=function(){var e=document.querySelectorAll(".counter-block-input")[0],o=document.querySelectorAll(".counter-block-input")[1],s=document.getElementById("select"),u=document.getElementById("total");function t(e,o,s){var t=+e.value,n=+o.value,r=+s.options[s.selectedIndex].value;u.innerHTML=t&&n?4e3*(t+n)*r:0}u.innerHTML=0,e.addEventListener("change",function(){t(o,e,s)}),o.addEventListener("change",function(){t(o,e,s)}),s.addEventListener("change",function(){t(o,e,s)}),document.querySelectorAll(".counter-block-input").forEach(function(o){o.removeAttribute("type"),o.addEventListener("input",function(){var e;e=o.value,/^\d+$/.test(e)||(o.value=o.value.slice(0,-1))})})}},"./src/js/parts/form.js":
/*!******************************!*\
  !*** ./src/js/parts/form.js ***!
  \******************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js"),s(/*! core-js/modules/es6.promise */"./node_modules/core-js/modules/es6.promise.js");o.default=function(){var r="Загрузка...",u="Спасибо! Скоро мы с вами свяжемся!",d="Что-то пошло не так...",e=document.getElementsByClassName("main-form")[0],o=document.getElementById("form"),c=document.createElement("div");function s(s){s.addEventListener("submit",function(e){e.preventDefault(),s.appendChild(c);var t,n=new FormData(s),o=s.getElementsByTagName("input");(t=n,new Promise(function(e,o){var s=new XMLHttpRequest;s.open("POST","server.php"),s.setRequestHeader("Content-type","application/json","charset=utf-8"),s.addEventListener("readystatechange",function(){s.readyState<4?e():4===s.readyState&&200==s.status?e():o(),n.forEach(function(e,o){}),JSON.stringify({})}),s.send(t)})).then(function(){return c.innerHTML=r}).then(function(){return c.innerHTML=u}).catch(function(){return c.innerHTML=d}).then(function(){for(var e=0;e<o.length;e++)o[e].value=""})})}c.classList.add("status"),c.style.cssText="color: #fff",s(e),s(o),document.querySelectorAll("[type = tel]").forEach(function(o){o.addEventListener("input",function(){var e;e=o.value,/^(\+|8)\d{0,10}$/.test(e)||(o.value=o.value.slice(0,-1))})})}},"./src/js/parts/modal.js":
/*!*******************************!*\
